...
if __name__ == '__main__':
    ...
    parser.add_argument ("-fo", "--file_out", help="Файл для записи результата", default="out.txt")
    ...
    if namespace.file:
        ...
        try:
            process.process_file(namespace.file, namespace.file_out, namespace.file_log, namespace.level_log) 
        ...
        try:
            process.process_network(namespace.symbol, namespace.year,  namespace.file_out, namespace.file_log, namespace.level_log)
        except Exception as e:
            logging.error(str(e))
